...
<meta property="og:url" content="https://tvtropes.org/pmwiki/about.php" />
...
<div id="random-box">
<a href="/pmwiki/pmwiki.php/Main/FascistsBedTime" class="button-random-trope" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random trope');"></a>
<a href="/pmwiki/pmwiki.php/WesternAnimation/ToyStory" class="button-random-media" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random media');"></a>
</div>
</div>
</div>
...
<div class="ImgUploadModalStub" data-page-type="About"></div>
...
<h1 itemprop="headline" class="entry-title">About TV Tropes</h1>
...
<p>These are the people working behind the scenes to keep the TVTropes project running. </p>
<div class="two-column gutter-top">
<div class="column-box left text-center">
<img src="../images/staff-drew.png" alt="drewski-img" style="width:50%" /><br />
<a class="font-l bold" href="/pmwiki/wiki_pm.php?to_troper=drewski">Drew</a>
<div class="font-xs">Co-Owner</div>
<p>Drew is one of the owners. We just blame him for everything.</p>
<p class="font-s">Favorite Trope: <a href="/pmwiki/pmwiki.php/Main/TheGadfly">The Gadfly</a></p>
</div>
<div class="column-box right text-center">
<img src="../images/staff-chris.png" alt="chris-img" style="width:50%" /><br />
<a class="font-l bold" href="/pmwiki/wiki_pm.php?to_troper=itcdr">Chris</a>
<div class="font-xs">Co-Owner</div>
<p>Chris is the other owner. You can blame him when there are database and server issues.</p>
<p class="font-s">Favorite Trope: <a href="/pmwiki/pmwiki.php/Main/NewMediaAreEvil">New Media Are Evil</a></p>
</div>
<div class="column-box mobile-off" style="height: 25px;"></div>
<div class="column-box left text-center">
<img src="../images/staff-tyler.png" alt="tyler-img" style="width:50%" /><br />
<a class="font-l bold" href="/pmwiki/wiki_pm.php?to_troper=dunn-ions">Tyler</a>
<div class="font-xs">Developer</div>
<p>Tyler does backend code, if the stuff front end doesn't work, blame him.</p>
<p class="font-s">Favorite Trope: <a href="/pmwiki/pmwiki.php/Main/NotAllowedToGrowUp">Not Allowed to Grow Up</a></p>
</div>
<div class="column-box right text-center">
<img src="../images/staff-cole.png" alt="cole-img" style="width:50%" /><br />
<a class="font-l bold" href="/pmwiki/wiki_pm.php?to_troper=colerich333">Cole</a>
<div class="font-xs">Social Media / Developer</div>
<p>Cole helps with design and is the one posting to Facebook every day. Blame him when you get lured back to another wiki walk.</p>
<p class="font-s">Favorite Trope: <a href="/pmwiki/pmwiki.php/Main/TheUnfavourite">The Un Favourite</a></p>
</div>
<div class="column-box mobile-off" style="height: 25px;"></div>
<div class="column-box left text-center">
<img src="../images/staff-tom.png" alt="tom-img" style="width:50%" /><br />
<a class="font-l bold" href="/pmwiki/wiki_pm.php?to_troper=devtom">Tom</a>
<div class="font-xs">Developer</div>
<p>Tom also does backend code, if the stuff front end doesn't work, blame him.</p>
<p class="font-s">Favorite Trope: <a href="/pmwiki/pmwiki.php/Main/ItKindOfLooksLikeAFace">It Kind of Looks Like a Face</a></p>
</div>
<div class="column-box right text-center">
<img src="../images/staff-klint.png" alt="clint-img" style="width:50%" /><br />
<a class="font-l bold" href="/pmwiki/wiki_pm.php?to_troper=klintadmin">Klint</a>
<div class="font-xs">Developer</div>
<p>Klint took a stab at redesigning the site, so if you don't like how things are layed out blame him.</p>
<p class="font-s">Favorite Trope: <a href="/pmwiki/pmwiki.php/Main/PolishTheTurd">Polish the Turd</a></p>
</div>
<div class="column-box mobile-off" style="height: 25px;"></div>
<div class="column-box left text-center">
<img src="../images/staff-klayten.png" alt="klayten-img" style="width:50%" /><br />
<a class="font-l bold" href="/pmwiki/wiki_pm.php?to_troper=devklay">Klayten</a>
<div class="font-xs">Developer</div>
<p>Klayten also does backend code, if the stuff front end doesn't work, blame him.</p>
<p class="font-s">Favorite Trope: <a href="/pmwiki/pmwiki.php/Main/HitlerAteSugar">Hitler Ate Sugar</a></p>
</div>
<div class="column-box right text-center">
<img src="../images/staff-tanner.png" alt="tanner-img" style="width:50%" /><br />
<a class="font-l bold" href="/pmwiki/wiki_pm.php?to_troper=DankScienceGuy">Tanner</a>
<div class="font-xs">Developer</div>
<p>Tanner also does backend code, if the stuff front end doesn't work, blame him.</p>
<p class="font-s">Favorite Trope: <a href="/pmwiki/pmwiki.php/Main/ExactlyWhatItSaysOnTheTin">Exactly What It Says On The Tin</a></p>
</div>
</div>
<h2 class="text-center gutter-topx2">The Founder</h2>
<div class="text-center gutter-top">
<img src="../images/staff-eddie.png" alt="fasteddie-img" /><br />
<span class="font-l bold">Fast Eddie </span>
<div class="font-xs">The Founder</div>
<p>The mysterious founder who helped start TVTropes back in 2004. He was the main admin for 10 years before retiring. Without him you probably wouldn't know what a trope is.</p>
</div>
</div>
</div>
