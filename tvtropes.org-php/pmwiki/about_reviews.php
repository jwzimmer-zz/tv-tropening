...
<meta property="og:url" content="https://tvtropes.org/pmwiki/about_reviews.php" />
...
<div id="random-box">
<a href="/pmwiki/pmwiki.php/Main/EvilTastesGood" class="button-random-trope" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random trope');"></a>
<a href="/pmwiki/pmwiki.php/Manga/HyperPolice" class="button-random-media" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random media');"></a>
</div>
</div>
</div>
...
<div class="ImgUploadModalStub" data-page-type="ReviewAbout"></div>
...
<div id="main-content" class="page-ReviewAbout class-reviews-about">
...
<div class="areview rounded">
<h1>About Reviews</h1>
<div class="review_text">
<p>
Reviews are limited to 400 words. That means there is very
little space for anything but review text. No room for a
recap or transcript. It comes down to whether or not you would
recommend the work and why you would or wouldn't.
The why is the interesting part.
</p>
<p>
<strong>Note:</strong> Spoiler font is turned off in Reviews.
So don't write spoilers.
</p>
<p>
Unlike most text around the wiki, a review is only editable by the reviewer.
It has a byline. Using first-person address would be a valid choice.
This is your chance to say "I liked it!"
</p>
<p>
We have moderators that have the power to delete stuff that needs deleting.
If they come across a review that is spelled badly and has crappy grammar,
they'll delete the review. Your spelling and your grammar are your
responsibility in your review.
</p>
<p>
Have fun with it. Both geeked-out nerdy fangasms and curmudgeonly
mutterings are expected. As long as it isn't boring.
</p>
</div>
</div>
<div class="endbuttonwrapper" onclick="history.back();">
