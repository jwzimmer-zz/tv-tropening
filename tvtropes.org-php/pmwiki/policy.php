...
<meta property="og:url" content="https://tvtropes.org/pmwiki/policy.php" />
...
<div id="random-box">
<a href="/pmwiki/pmwiki.php/Main/BigScrewedUpFamily" class="button-random-trope" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random trope');"></a>
<a href="/pmwiki/pmwiki.php/Fanfic/FriendshipIsOptimalCaelumEstConterrens" class="button-random-media" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random media');"></a>
</div>
</div>
</div>
...
<div class="ImgUploadModalStub" data-page-type="Policy"></div>
...
<div id="main-content" class="page-Policy ">
