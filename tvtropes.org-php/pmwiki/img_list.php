...
<meta property="og:url" content="https://tvtropes.org/pmwiki/login_prompt.php?referrer=%2Fpmwiki%2Fimg_list.php" />
...
<div id="random-box">
<a href="/pmwiki/pmwiki.php/Main/PantyShot" class="button-random-trope" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random trope');"></a>
<a href="/pmwiki/pmwiki.php/Literature/OnTheRoad" class="button-random-media" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random media');"></a>
</div>
</div>
</div>
...
<input type="hidden" name="current_url" value="http://tvtropes.org/pmwiki/login_prompt.php?referrer=%2Fpmwiki%2Fimg_list.php">
<input type="hidden" name="modal_type" value="modal_login_cont">
<input type="hidden" data-form-element-name="redirect_url" name="redirect_url" value="/pmwiki/img_list.php">
