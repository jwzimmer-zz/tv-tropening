...
<meta property="og:url" content="https://tvtropes.org/pmwiki/contact.php" />
...
<link rel="stylesheet" href="/design/css/contact.css?rev=61acae6dced8ebb8defa29cde07b1ab8e1d61ca7" type="text/css">
<script>
...
<div id="random-box">
<a href="/pmwiki/pmwiki.php/Main/Elfeminate" class="button-random-trope" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random trope');"></a>
<a href="/pmwiki/pmwiki.php/Film/TheBonesBrigadeAnAutobiography" class="button-random-media" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random media');"></a>
</div>
</div>
</div>
...
<div class="ImgUploadModalStub" data-page-type="Contact"></div>
...
<h1 itemprop="headline" class="entry-title">Contact TV Tropes</h1>
...
<div class="acaptionright">
<p class="bold">Support Links</p>
<hr />
<a href="/pmwiki/query.php?type=att">Ask the tropers</a><br />
<a href="/pmwiki/query.php?type=bug">Report bugs</a><br />
<a href="/pmwiki/query.php?type=wl">Request features</a><br />
<a href="/pmwiki/pmwiki.php/Administrivia/WelcomeToTVTropes">User Guide</a><br />
<a href="/pmwiki/policy.php">Site policies</a>
</div>
<p>If you're in need of assistance with anything on the TV Trope site, you can email the staff at TVTropes, and we'll do whatever we can.</p>
<p>We love to talk to our community members and if you choose to reach out to us we'll get back to you as soon as we can, but we encourage you to check the support links first to see if you can find the answer to your question there.</p>
<hr />
<div class="form-wrapper contact-us contact-us-form">
<div class="error_msg" style="display:none;"></div>
<div class="success-msg" style="display:none;">Your message has been sent successfully.</div>
<form class="form-horizontal contact-form input-form-cont" method="POST" action="/ajax/contact-us.php" enctype="multipart/form-data">
<div class="clearfix">
<div class="column-box">
<div class="width-50">
<label for="recipient-email">Send email to:</label>
<select name="recipient-email" id="recipient-email">
<option value="mods">The Moderators</option>
<option value="staff">The Staff</option>
</select>
</div>
</div>
</div>
...
<input id="contact-name" name="name" type="text" placeholder="Name" class="validate form-control">
</div>
</div>
...
<i class="fa fa-check-circle form-icon"></i>
<div class="error-msg"></div>
<input id="contact-email" name="email" type="text" placeholder="Email Address" class="validate form-control">
</div>
</div>
</div>
<div class="form-group contact-msg">
<div class="form-group-wrapper">
<i class="fa fa-check-circle form-icon"></i>
<div class="error-msg"></div>
<textarea class="validate form-control" id="contact-msg" name="message" placeholder="Your Message"></textarea>
</div>
</div>
...
<a class="upload-file-btn btn" href="#">
<span class="inner clearfix">
<span class="upload-btn-item">Browse</span>
<span class="upload-btn-label">No File Selected</span>
</span>
</a>
<input class="file-input-btn" type="file" id="exampleInputFile" name="file-upload">
<p class="help-block">Upload a screenshot, if necessary</p>
</div>
</div>
<div class="form-group">
<button type="submit" class="blue submit">Send</button>
</div>
</div>
<div class="right-side">
<div class="g-recaptcha" data-sitekey="6LeUf3IUAAAAAL23DlObCQzk9CUx5uDLxoSN3rSn" data-callback="enableBtn"></div>
</div>
</div>
</form>
</div>
...
<script type="text/javascript">
        ...
        elem.onload = function() {
                ...
                elem2.async = false;
                elem2.src = "/design/js/contact-us.js?rev=61acae6dced8ebb8defa29cde07b1ab8e1d61ca7";
