...
<div id="random-box">
<a href="/pmwiki/pmwiki.php/Main/UseYourHead" class="button-random-trope" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random trope');"></a>
<a href="/pmwiki/pmwiki.php/VideoGame/JusticeLeagueHeroesTheFlash" class="button-random-media" rel="nofollow" onclick="ga('send', 'event', 'button', 'click', 'random media');"></a>
</div>
</div>
</div>
...
browser. To opt out of this use, please click here (<a href="https://liveramp.com/opt_out/">LiveRamp</a>).
</p>
<br>
<div class="note">
...
<li><a href="javascript:googlefc.callbackQueue.push(googlefc.showRevocationMessage)">Manage EU Consent (GDPR)</a></li>
</ul>
</p>
